    ...
    return (
        <div className='bg-pink-100  p-4 w-[95%]  m-auto sm:w-[70%]  mt-[2em] flex justify-around'>
            <div className='max-w-[52%] flex flex-col justify-center'>
                <span className='font-bold text-lg sm:text-4xl lg:text-6xl font-sans '>Exclusive Offer for You</span>
                <p className='my-[1em] sm:text-sm text-xs  font-semibold'>ONLY ON BEST SELLERS PRODUCT</p>
